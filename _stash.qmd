...
── Error (test-select_by_class.R:52:5): select_by_class() works ─────
...
Similar to the `make_binary_vec()` tests, I've created a [`cat_maker()`](https://github.com/mjfrigaard/utap/blob/cf97049cb4ab5378d2d7a3b3e3f3973061c8b2d7/tests/testthat/helpers.R#L187) function to help create facet test data. 

```{r}
#| eval: true
#| code-fold: show 
#| code-summary: cat_maker() helper
cat_maker(
...
I'll create test data for the `cat_maker()` tests, `facet_vec_test`, and store it in the `tests/testthat/fixtures/make_facet_vec_test.R` file:
...
facet_vec_test <- tibble::tibble(
  # character facets
  cat_maker(type = "chr", size = 10, lvls = 5, missing = FALSE),
  cat_maker(type = "chr", size = 10, lvls = 5, missing = TRUE),
  cat_maker(type = "chr", size = 10, lvls = 6, missing = FALSE),
  cat_maker(type = "chr", size = 10, lvls = 6, missing = TRUE),
  # factor facets
  cat_maker(type = "fct", size = 10, lvls = 5, missing = FALSE),
  cat_maker(type = "fct", size = 10, lvls = 5, missing = TRUE),
  cat_maker(type = "fct", size = 10, lvls = 6, missing = FALSE),
  cat_maker(type = "fct", size = 10, lvls = 6, missing = TRUE),
  # ordered facets
  cat_maker(type = "ord", size = 10, lvls = 5, missing = FALSE),
  cat_maker(type = "ord", size = 10, lvls = 5, missing = TRUE),
  cat_maker(type = "ord", size = 10, lvls = 6, missing = FALSE),
  cat_maker(type = "ord", size = 10, lvls = 6, missing = TRUE)) |>
...
pull_cols_test <- tibble::tibble(
     ...
     # character facets
     chr_facet5 = cat_maker(type = "chr", size = 10,
                              lvls = 5, missing = FALSE),
     chr_facet5_na = cat_maker(type = "chr", size = 10,
                              lvls = 5, missing = TRUE),
     # factor facets
     fct_facet5 = cat_maker(type = "fct", size = 10,
                              lvls = 5, missing = FALSE),
     fct_facet5_na = cat_maker(type = "fct", size = 10,
                              lvls = 5, missing = TRUE),
     # ordered facets
     ord_facet5 = cat_maker(type = "ord", size = 10,
                              lvls = 5, missing = FALSE),
     ord_facet5_na = cat_maker(type = "ord", size = 10,
                              lvls = 5, missing = TRUE))
